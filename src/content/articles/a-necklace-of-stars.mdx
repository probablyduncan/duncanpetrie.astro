...
metadata: {
    tags: {
        title: true,
        url: true,
        location: "[Falmouth](/photography/falmouth), and an Airbus over the North Atlantic",
        links: '[Home](/), [Photography](/photography), [Writing](/writing)',
        from: "[Springtide](/springtide)",
        about: true,
        language: "Old Edyan (translated winter 2022)",
        words: 1504,
    },
    tagSpacing: [7,7,6,7,5,6,5,7,],
}
image: {
    photoName: dunegrass-lake-michigan-2021-03-28,
    noCaption: true,
}
---
