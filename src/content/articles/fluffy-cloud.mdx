...
image: {
    ...
    caption: The fluffiest cloud in the western stratosphere.,
}
related: [ on-yearning, lingermyth, horizons, coast-path ]
metadata: {
    where: "Falmouth, in a moment of clarity.",
    why: "I was redesigning my website, in 2021, and it needed more content.",
    how: "science!",
    state: "deep.",
