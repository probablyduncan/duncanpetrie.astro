...
metadata: {
    tags: {
        title: true,
        url: true,
        written in: "[London](/photography/london), August, in a hot attic flat with a glass of ice water",
        links: '[Home](/), [Photography](/photography), [Writing](/writing)',
        from: "[Springtide](/springtide)",
        about: true,
        words: 4573,
        hat: floppy,
        years ago: many,
    },
    tagSpacing: [7,7,6,7,4,6,5,]
}
image: {
    photoName: melted-moon-falmouth-bay-2021-10-15,
    noCaption: true,
}
---

**Many years ago,** the Baron of Inselberg was born in Alexa. His family, the hereditary rulers of the faraway town of Inselbergdrumlind, had lived in Alexa for generations; it was a fashionable place to be émigré nobility, and little remained for them in the quiet old country.
