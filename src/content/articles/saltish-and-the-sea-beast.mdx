...
metadata: {
    written in: "[London](/london), February, under a leaking roof",
    from: "[Springtide](/springtide), and the Ministry for the Telling of Far-fetched Tales",
    words: 8140,
}
related: [ hithlid, sea, little-man-edge-of-heaven, a-necklace-of-stars, the-barons-old-fleet, horizons ]
image: {
    # photoName: old-bones-dungeness-2024-01-28,
