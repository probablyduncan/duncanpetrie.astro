...
metadata: {
    location: "[Falmouth](/falmouth), Fall 2020",
    plot: "Nowhere to be found",
    writing skills: fledgling,
}
related: [ a-necklace-of-stars, saltish-and-the-sea-beast, lingermyth ]
image: {
    # photoName: antiques-ventnor-2024-04-28,
    photoName: butterfly-ventnor-2024-04-28,
    noCaption: true,
}
---
