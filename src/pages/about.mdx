...
title: About
summary: Duncan Petrie? Who is this guy?
date: 2024-07-17
metadata: {
    title: true,
    in: "London, UK",
    from: "Milwaukee, WI",
    links: "[Home](/), [Email me](mailto:duncanpetrie1@gmail.com), [Instagram](https://instagram.com/probablyduncan), [LinkedIn](https://www.linkedin.com/in/probablyduncan/), [Resume](/resume.pdf), [Photography](/photography), [Writing](/writing), [Springtide](/springtide)",
}
metadataSpacing: [7,5,5,7,]
coverImage: {
    photoName: me,
    captionAlign: 'right',
}
